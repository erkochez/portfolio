...
const DEFAULT_BEHIND_GRADIENT =
  'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(220,100%,70%,var(--card-opacity)) 4%,hsla(220,50%,60%,calc(var(--card-opacity)*0.75)) 10%,hsla(220,25%,40%,calc(var(--card-opacity)*0.5)) 50%,hsla(220,0%,30%,0) 100%),radial-gradient(35% 52% at 55% 20%,#00aaffc4 0%,#073aff00 100%),radial-gradient(100% 100% at 50% 50%,#0061ffff 1%,#073aff00 76%),conic-gradient(from 124deg at 50% 50%,#37ceff 0%,#3b82f6 40%,#0061ff 60%,#37ceff 100%)';
